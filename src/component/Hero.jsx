...
export default function Hero() {
  return (
    <>
      ...
      <p className="pb-6">
        Full-stack web developer and visual artist focused on clean design,
        smooth user experiences, and efficient web solutions.
      </p>
      ...
      <div className="mt-6">
        <div className="mx-auto w-full max-w-xl bg-neutral rounded-3xl border-2 border-black shadow-[6px_6px_0_#000] p-6 text-left">
          ...
          <div className="mt-2 text-2xl font-bold">Miftah Adz Dzaudan I.</div>
          <p className="mt-2 text-sm opacity-80">
            Full-stack web developer & visual artist. Open for freelance and
            collaboration.
          </p>
          <a
